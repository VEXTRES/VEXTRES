                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end space-x-2">
                                        <form action="{{route('contacts.destroy', $contact)}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="font-bold py-2 px-4 rounded bg-red-500 text-white">Eliminar</button>
                                        </form>
                                        <a href="{{route('contacts.edit', $contact->id)}}" class="btn btn-blue">Editar</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
